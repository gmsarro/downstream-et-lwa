...
Hovmoller composites restricted to WP storms only (paper Fig. 12)."""
...
def main(
        ...
        figure_name: Annotated[str, typer.Option()] = (
            "fig12_mpas_rwp_lwa_wp_only_recurvature.png"),
    ...
    fig.suptitle(
        f"{ref_lbl} \N{EM DASH} Fig.~12 MPAS current vs future, "
