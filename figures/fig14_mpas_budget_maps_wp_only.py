"""MPAS current vs future LWA-budget composite maps, WP storms only
(paper Fig. 14)."""
...
def main(
        ...
        figure_name: Annotated[str, typer.Option()] = (
            "fig14_mpas_budget_maps_cf_wp_only_recurvature.png"),
    ...
    budget_maps.plot_budget_wp_na_fig5(
        ...
        strat_column_titles=(
            f"MPAS current (WP only, N={n_c})",
            f"MPAS future (WP only, N={n_f})",
        ),
