"""Paper Fig. 8 (RWB stratification): ERA5 LWA-budget Hovmoller matching
the Fig. 3 layout, stacked high vs low downstream RWB (WP+NA pooled)."""
...
def main(
        ...
        = "fig08_lwa_budget_era5_wp_na_wb_strat_{reference}.png",
