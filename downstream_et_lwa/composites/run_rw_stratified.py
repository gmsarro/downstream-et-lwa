"""CLI: budget + MERRA-2 source composites for rwcase / norwcase strata."""
...
def main(
        ...
        classification_csv: Annotated[Path, typer.Option(
            help="CSV with storm_id, reference, wb_group from classification.rw")],
